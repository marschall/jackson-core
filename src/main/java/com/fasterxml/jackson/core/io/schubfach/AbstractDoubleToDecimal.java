 ...
 */
public abstract class AbstractDoubleToDecimal {
    /*
    ...
    AbstractDoubleToDecimal() {
    }

    int appendDecimalTo(double v, Object array, int off) {
     ...
     */
    private int toDecimal(double v, int offset, Object array) {
        /*
    ...
    private int toDecimal(int q, long c, int dk, int offset, Object array) {
        /*
     ...
     */
    private int toChars(long f, int e, int offset, Object array) {
        /*
        ...
        if (0 < e && e <= 7) {
            return toChars1(h, m, l, e, offset, array);
        }
        if (-3 < e && e <= 0) {
            return toChars2(h, m, l, e, offset, array);
        }
        return toChars3(h, m, l, e, offset, array);
    }

    private int toChars1(int h, int m, int l, int e, int offset, Object array) {
        /*
        ...
        index = lowDigits(l, index, array);
        return index;
    }

    private int toChars2(int h, int m, int l, int e, int offset, Object array) {
        ...
        index = appendDigit(h, index, array);
        index = append8Digits(m, index, array);
        index = lowDigits(l, index, array);
        return index;
    }

    private int toChars3(int h, int m, int l, int e, int offset, Object array) {
    ...
    private int lowDigits(int l, int offset, Object array) {
        int index = offset;
        if (l != 0) {
